import getLocationSearchMap from './get-location-search-map.mjs';

export default class AMapInitializer {
  static init = async (container) => {
    const locationSearchMap = getLocationSearchMap();
    window._AMapSecurityConfig = {
      securityJsCode: locationSearchMap.amapsec,
    };
    await import('https://webapi.amap.com/loader.js');
    window.AMap = await AMapLoader.load({
      key: locationSearchMap.amapkey, //申请好的Web端开发者key，调用 load 时必填
