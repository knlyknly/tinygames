  ...
  const Patterns = [
    {
      name: 'LONG',
      forms: [
        applies(shapes.LONG, [offset, 0, 2], [cut]),
        applies(shapes.LONG, [rotate], [offset, 1, 0], [cut]),
      ],
    },
    {
      name: 'RECT',
      forms: [
        applies(shapes.RECT, [offset, 1, 1], [cut]),
      ],
    },
    {
      name: 'L',
    ...
    },
    {
      name: 'Z',
      forms: [
        applies(shapes.Z, [offset, 0, 1], [cut]),
        applies(shapes.Z, [rotate], [offset, 1, 0], [cut]),
      ],
    },
    {
      name: 'MIRROREDZ',
      forms: [
        applies(shapes.Z, [mirror], [offset, 0, 1], [cut]),
        applies(shapes.Z, [mirror], [rotate], [offset, 0, -1], [cut]),
      ],
    },
    {
      name: 'T',
